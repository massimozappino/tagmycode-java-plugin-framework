...
//        setValuesForWalletAndData();
//
//        User newUser = resourceGenerate.aUser().setUsername("fakeUsername");
...
//
//        FrameworkConfig frameworkConfig = new FrameworkConfig(framework.getFrameworkConfig().getPasswordKeyChain(),
//                framework.getStorageEngine().getStorage(),
//                framework.getStorageEngine().getDbService(),
//                framework.getMessageManager(),
//                framework.getTaskFactory(),
//                framework.getParentFrame());
//        Framework reloadedFramework = spy(new Framework(new TagMyCodeApiDevelopment(), frameworkConfig, new FakeSecret(), "test"));
//
//        reloadedFramework.start();
//
//        verify(reloadedFramework, times(1)).saveSnippetsDataChanged();
//        assertEquals(newOauthToken, reloadedFramework.getTagMyCode().getOauthToken());
